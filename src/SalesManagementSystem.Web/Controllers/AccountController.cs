...
using SalesManagementSystem.Sessions;
using SalesManagementSystem.Web.Controllers.Results;
using SalesManagementSystem.Web.Models;
using SalesManagementSystem.Web.Models.Account;
...
{
    public class AccountController : SalesManagementSystemControllerBase
    {
