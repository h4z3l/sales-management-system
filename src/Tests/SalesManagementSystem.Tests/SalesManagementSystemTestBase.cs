...
using SalesManagementSystem.Migrations.SeedData;
...
{
    public abstract class SalesManagementSystemTestBase : AbpIntegratedTestBase<SalesManagementSystemTestModule>
    {
        private DbConnection _hostDb;
        private Dictionary<int, DbConnection> _tenantDbs; //only used for db per tenant architecture

        protected SalesManagementSystemTestBase()
        {
        ...
        protected void UsingDbContext(Action<SalesManagementSystemDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<SalesManagementSystemDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<SalesManagementSystemDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<SalesManagementSystemDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<SalesManagementSystemDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<SalesManagementSystemDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<SalesManagementSystemDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<SalesManagementSystemDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<SalesManagementSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<SalesManagementSystemDbContext, Task<T>> func)
        {
            T result;
